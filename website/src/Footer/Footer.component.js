            ...
            <div className="footer-wrapper">
                <div className="first-bloc">
                    <div className="footer-logo">
                        <svg xmlns="http://www.w3.org/2000/svg" width="146" height="24"><g fill="none" fill-rule="evenodd">
                ...
                <div className="last-bloc">
                    <div className="button-bloc">
                        <div className="footer-inbox">
                            <div className="inbox-text">Updateds in your inbox...</div>
                        </div>
                        <div className="go-button">
                            <div className="button-text">Go</div>
                        </div>
                    </div>
                    <div className="copyright-bloc">
                        <div className="copyright-text">copyright 2020. All RIghts Reserved</div>
                    </div>
                </div>
            </div>
        </div>
